...
Once you log in you will see this page as shown below. It is an information page and direct you to all the practice hooks.
...
When connecting to the Vm’s IP address the infrastructure looks like as below: 
